...
import { createProductAttribute } from "@/app/actions/product-attribute-actions"
...
interface CreateProductAttributeModalProps {
  open: boolean
  onOpenChange: (open: boolean) => void
}

export function CreateProductAttributeModal({ open, onOpenChange }: CreateProductAttributeModalProps) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      toast({
        ...
        description: `Attribute ${values.name} has been created successfully.`,
      })
      form.reset()
      onOpenChange(false)
    } catch (error: any) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>Create New Product Attribute</DialogTitle>
          <DialogDescription>Add a new attribute to your product catalog.</DialogDescription>
        </DialogHeader>
        <Form {...form}>

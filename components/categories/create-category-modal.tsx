...
export function CreateCategoryModal({ open, onOpenChange, parentCategories }: CreateCategoryModalProps) {
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <CategoryImageUpload onImageChange={(file) => field.onChange(file)} />
                  <FormMessage />
                </FormItem>
              )}
            />
